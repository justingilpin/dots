...
// TOP BAR: horizontal tray — fixed height, dynamic width.
// Previously vertical for the left-side bar.
// Column → Row; expand icon moves from bottom → right; implicitHeight ↔ implicitWidth.
    ...
    Loader {
        ...
        sourceComponent: Item {
            ...
            MaterialIcon {
                ...
                // Flipped when expanded (points left to collapse)
